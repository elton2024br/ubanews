-- Script simples para inserir dados administrativos
...
SELECT email, full_name, role FROM admin_users LIMIT 3;

SELECT 'Notícias inseridas:' as info;
SELECT title, status, category FROM admin_news LIMIT 3;